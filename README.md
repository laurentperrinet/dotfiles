# Laurent's configuration files (was Mathias’s dotfiles)
...
```bash
cd; curl -#L https://github.com/meduz/dotfiles/tarball/master | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh,LICENSE-MIT.txt}
```
...
GIT_AUTHOR_EMAIL="laurent.perrinet@gmail.com"
GIT_COMMITTER_EMAIL="$GIT_AUTHOR_EMAIL"
git config --global user.email "$GIT_AUTHOR_EMAIL"
```

You could also use `~/.extra` to override settings, functions and aliases from my dotfiles repository. It’s probably better to [fork this repository](https://github.com/meduz/dotfiles/fork) instead, though.
